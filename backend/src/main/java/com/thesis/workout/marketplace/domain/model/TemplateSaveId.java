...
@Embeddable
public class TemplateSaveId implements Serializable {
    ...
    protected TemplateSaveId() {
    }

    public TemplateSaveId(UUID userId, UUID templateId) {
        this.userId = userId;
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof TemplateSaveId that)) {
            return false;
        }
